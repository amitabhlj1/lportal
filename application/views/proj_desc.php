           ...
           <div class="col-md-12 col-xs-12 col-md-12 col-lg-12">
              <?php
                    if(!$this->session->userdata('exp_id')){
                        echo "<a href='".base_url("LangExpert")."' class='btn btn-primary form-control'><b>Please login as a language expert to apply to this Project</b></a>";
                    } else {
                        if(is_array($chk)){
                            ...
                            echo "<a href='".base_url()."Expert/apply_proj/".$jd->id."/".$comp->id."' class='btn btn-primary form-control'>Apply to this Project</a>";
                        }
                    }
               ?>
           </div>            
