                       ...
                       <div class="col-lg-10">
						<section class="panel">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" id="b_p_frm" role="form" method="post" action="<?php echo base_url()?>Translation/bingTranslation">

									<div class="form-group">					
									  <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">From</label>
									  <div class="col-lg-2">
											<select required="true" class="form-control m-b-10" id="b_flng" name="b_flng" >
												<option value="af">Afrikaans</option>
												<option value="sq">Albanian</option>
												<option value="am">Amharic</option>
												<option value="ar">Arabic</option>
									  ...
									  <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">To</label>
									  <div class="col-lg-2">
											<select required="true" class="form-control m-b-10" id="b_tlng" name="b_tlng" >
												<option value="af">Afrikaans</option>
															<option value="sq">Albanian</option>
															<option value="am">Amharic</option>
															<option value="ar">Arabic</option>
										  ...
										  <p class="help-block"><div id="b_err_lan" style="color:#F83A18"></div></p>
									  </div>	
									</div>
									...
									<div class="form-group">
									  ...
									  <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Text</label>
									  <div class="col-lg-10">
										<textarea id="b_l_text" name="b_l_text" class="msg-input" placeholder="text to translate..." rows="6" cols="70"></textarea>
										  <p id='b_rev_char_count'></p>
										  <p class="help-block"><div id="b_err_txt" style="color:#F83A18"></div></p>
									  </div>
									</div>

									<div class="form-group">
									  <div class="col-lg-offset-2 col-lg-10">
										  <button type="button" class="btn btn-danger" onclick="bingTranslation()">Bing</button>
									  </div>
									</div>
								</form>
								</div>
                       ...
                       <div class="col-lg-10">
						<section class="panel">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" id="b_p_frm" role="form" method="post" action="<?php echo base_url()?>Translation/yandexTranslation">
									...
									<div class="form-group">
									  <div class="col-lg-offset-2 col-lg-10">
										  <button type="button" id='trww' class="btn btn-danger">Yandex</button>
									  </div>
									</div>
								</form>
								</div>
...
function bingTranslation()
{		
	$("#b_err_txt").html('');
	$("#b_err_lan").html('');
	
	var l_text   = $("#b_l_text").val();
	var flng     = $("#b_flng").val();
	var tlng     = $("#b_tlng").val();
	
	if(flng == tlng)
	{
		$("#b_err_lan").html('both languages cannot be same');		
		return false;
	}
	
	if(l_text == '')
	{
		$("#b_err_txt").html('please enter text');		
		return false;
	}	
