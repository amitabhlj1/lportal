			...
			<div class="panel-body">
				...
				<form class="form-horizontal" id="eventfrm" role="form" method="post" action="<?php echo base_url()?>ado/Employer/saveJob">
					...
					<div class="form-group">					
					  ...
					  <div class="col-lg-10">
						  <input type="text" required="true" class="form-control" name="job_keywords" id="job_key" placeholder="comma separated job keywords/tags" value="" maxlength="450">
					...
					<div class="form-group">
					  <label for="description" class="col-lg-2 col-sm-2 control-label">Location / City</label><div class="col-lg-10">
						<input type="text" required="true" class="form-control" name="address" id="autocomplete" placeholder="job location/address" value="" maxlength="250">
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-10">
						  <textarea id="description" name="description" class="msg-input form-control" placeholder="Job details..." rows="6" cols="90"></textarea>
				...
				<span id="prjfrm" style="display:none">
					<form class="form-horizontal" id="p_frm" role="form" method="post" action="<?php echo base_url()?>ado/Employer/saveProjectJob">
						...
						<div class="form-group">
						  <label for="description" class="col-lg-2 col-sm-2 control-label">Location / City</label><div class="col-lg-10">
							<input type="text" required="true" class="form-control" name="f_address" id="autocomplete1" placeholder="job location/address" value="" maxlength="250">
						...
						<div class="form-group">
						  ...
						  <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Job Detail</label>
						  <div class="col-lg-10">
							  <textarea id="f_description" name="f_description" class="msg-input form-control" placeholder="Job details..." rows="6" cols="90"></textarea>
