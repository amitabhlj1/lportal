...
<head>
	...
	<!-- datepicker -->
	<!--
	<link href="<?php echo base_url();?>assets/admin/css/bs-datetimepicker/bootstrap-datetimepicker.css" rel="stylesheet">
	-->
    ...
    <body class="skin-black">		
        ...
        <header class="header">			
            ...
            <nav class="navbar navbar-static-top" role="navigation">				
				...
				<a href="#" style="margin-top:15px;margin-left:30px;"> <b><?php echo $this->session->userdata('school_name'); ?></b> </a>
				<span>&nbsp;&nbsp;<img src="<?php echo base_url();?>assets/uploads/logo.jpg" > </span>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                                ...
                                <li class="divider"></li>
                                <li>
									<a href="<?php echo base_url();?>ado/school/School/profile">
										<i class="fa fa-user fa-fw pull-right"></i>School Profile
									</a>										
									<a href="<?php echo base_url();?>ado/School/changePassword">
										<i class="fa fa-cog fa-fw pull-right"></i>Change Password
									</a>
								</li>
								<li class="divider"></li>
								<li>
									<a href="<?php echo base_url()?>ado/school/School/logout"><i class="fa fa-ban fa-fw pull-right"></i> Logout</a>
								</li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <section class="sidebar">
						...
						<ul class="sidebar-menu">
							<li>
								<a href="<?php echo base_url();?>ado/school/School">
									<i class="fa fa-gavel"></i><span>Dashboard</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>ado/school/School/attendance">
									<i class="fa fa-gavel"></i><span>Attendance</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>ado/school/Setting">
									<i class="fa fa-gavel"></i><span>Settings</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>ado/school/Nonteaching">
									<i class="fa fa-gavel"></i><span>Non Teaching</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>ado/school/School/Leave">
									<i class="fa fa-gavel"></i><span>Leave Management</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>ado/school/Timetable">
									<i class="fa fa-gavel"></i><span>Time Table</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>ado/school/question">
									<i class="fa fa-globe"></i> <span>Questions</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>ado/school/Holidays">
						...
						<div class="col-md-2">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
									<a href="<?php echo base_url();?>ado/school/Student/">
                       	...
                       	<div class="col-md-2">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
									<a href="<?php echo base_url();?>ado/school/Teacher">
										<span><?php echo $iTeachers;?></span>Teachers
									</a>
                                </div>
							</div>
                        </div>
