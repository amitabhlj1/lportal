...
INSERT INTO `cities` (`id`, `name`, `s_id`) VALUES
(1, 'Bombuflat', 1),
(2, 'Garacharma', 1),
(3, 'Port Blair', 1),
(4, 'Rangat', 1),
...
CREATE TABLE `comments` (
  `id` int(11) NOT NULL,
  `job_id` int(11) NOT NULL COMMENT 'comments for this job',
  `company_id` int(11) NOT NULL COMMENT 'by this company',
  `expert_id` int(11) NOT NULL COMMENT 'by this expert',
  `sender` tinyint(1) NOT NULL COMMENT '1 - company, 2 - lang expert',
  `comment` mediumtext NOT NULL COMMENT 'comment text',
  `read_status` tinyint(1) NOT NULL COMMENT 'read status  ( 0 - unread, 1 - read) ',
  `created` date NOT NULL COMMENT 'comment date',
  `status` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='comments data for a job';

--
-- Dumping data for table `comments`
--

INSERT INTO `comments` (`id`, `job_id`, `company_id`, `expert_id`, `sender`, `comment`, `read_status`, `created`, `status`) VALUES
(1, 2, 1, 2, 1, 'Hello Vinod,\r\n\r\nHow are you?', 0, '2018-05-23', 1),
(2, 2, 1, 2, 2, 'Yes I am good.', 0, '2018-05-24', 1),
(3, 2, 1, 2, 2, 'are you there?', 0, '2018-05-24', 1),
(5, 2, 1, 2, 1, 'Yes, I am here. \r\n\r\nI would like to know if you\'re open with the rates which I have posted?', 0, '2018-05-24', 1),
(6, 2, 1, 2, 2, 'Before I could react the three \r\noccupants of the car came out and started abusing me in front of my son. My son got \r\nscared and he caught my hand tightly.', 0, '2018-05-24', 1),
(8, 2, 1, 2, 2, 'Before I could react the three \r\noccupants of the car came out and started abusing me in front of my son. My son got \r\nscared and he caught my hand tightly.', 0, '2018-05-24', 1),
(9, 2, 1, 2, 2, 'but you have to think about\r\nit', 0, '2018-05-24', 1),
(10, 2, 1, 2, 2, 'Yes, I am. what is the TAT?', 0, '2018-05-28', 1);
...
CREATE TABLE `country` (
  ...
  `c_code` varchar(20) NOT NULL COMMENT 'country code',
  `c_name` varchar(150) NOT NULL COMMENT 'country name',
...
INSERT INTO `country` (`id`, `c_code`, `c_name`, `phonecode`, `status`) VALUES
...
CREATE TABLE `jobs` (
  ...
  `tat` date NOT NULL COMMENT 'turn around time',
  `last_date` date NOT NULL,
  `created` date NOT NULL,
  `status` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='project based, freelance jobs';
...
CREATE TABLE `job_apply` (
  ...
  `company_id` int(11) NOT NULL COMMENT 'company posted this job',
  `expert_id` int(11) NOT NULL COMMENT 'user who applied',
  `apply_date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='data for user applicants ';

--
-- Dumping data for table `job_apply`
--

INSERT INTO `job_apply` (`id`, `job_id`, `company_id`, `expert_id`, `apply_date`) VALUES
(1, 1, 1, 2, '2018-05-16'),
(5, 2, 1, 2, '2018-05-23');
...
INSERT INTO `job_category` (`id`, `cat_name`, `status`) VALUES
(1, 'accounts', 1),
(2, 'Management', 1),
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='job skills data';

--
-- Dumping data for table `job_skills`
--

INSERT INTO `job_skills` (`id`, `name`, `status`) VALUES
(1, 'Translation', 1),
(2, 'Documentation', 1);
...
--
-- Table structure for table `lang_company`
--

CREATE TABLE `lang_company` (
  `id` int(11) NOT NULL,
  `first_name` varchar(200) NOT NULL,
  `last_name` varchar(200) NOT NULL,
  `user_id` varchar(150) NOT NULL COMMENT 'user id ( old users login)',
  `email` varchar(150) NOT NULL,
  `password` varchar(255) NOT NULL,
  `company_name` varchar(200) NOT NULL COMMENT 'company name',
  `address` varchar(250) NOT NULL,
  `no_emp` varchar(150) NOT NULL COMMENT 'number of employees',
  `mobile` varchar(50) NOT NULL COMMENT 'company mobile no',
  `resume_plan` tinyint(1) NOT NULL COMMENT 'plan subscribed (1 - basic, 2- advance, 3 - Unlimited)',
  `plan_starts` date NOT NULL COMMENT 'when resume plan starts',
  `company_description` mediumtext NOT NULL COMMENT 'company brief decription',
  `company_website` varchar(200) NOT NULL COMMENT 'company website url',
  `company_logo` varchar(200) NOT NULL COMMENT 'company logo',
  `thumb_logo` varchar(200) NOT NULL COMMENT 'thumb size logo',
  `country` smallint(4) NOT NULL,
  `state` varchar(150) NOT NULL,
  `city` varchar(150) NOT NULL,
  `image` varchar(200) NOT NULL COMMENT 'employee image',
  `code` varchar(150) NOT NULL COMMENT 'employee unique code',
  `social_login` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'is social media used for registration',
  `social_id_no` bigint(4) NOT NULL DEFAULT '0' COMMENT 'if social media registration then identifier number',
  `social_name` varchar(100) NOT NULL COMMENT 'social media name',
  `email_verify` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'email verification status',
  `last_login` date NOT NULL COMMENT 'Last login date and time',
  `is_online` tinyint(1) NOT NULL DEFAULT '0' COMMENT '(1 - online available, 0 - offline, 2 - busy)',
  `created` date NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `lang_company`
--
...
--
-- Table structure for table `lang_expert`
--

CREATE TABLE `lang_expert` (
  `id` int(11) NOT NULL,
  `first_name` varchar(200) NOT NULL,
  `last_name` varchar(200) NOT NULL,
  ...
  `password` varchar(255) NOT NULL,
  `expert_in` varchar(100) NOT NULL COMMENT 'expert in these languages',
  `skills` mediumtext NOT NULL COMMENT 'comma separated skills ',
  `about_me` mediumtext NOT NULL COMMENT 'about lang expert',
  `resume` varchar(200) NOT NULL COMMENT 'expert resume ( file name of doc,pdf file)',
  `country` smallint(4) NOT NULL,
  `state` varchar(150) NOT NULL,
  `city` varchar(150) NOT NULL,
  `image` varchar(200) NOT NULL COMMENT 'expert image',
  `total_exp` tinyint(1) NOT NULL DEFAULT '0',
  `code` varchar(150) NOT NULL COMMENT 'expert unique code',
  `social_login` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'is social media used for registration',
  `social_id_no` bigint(4) NOT NULL DEFAULT '0' COMMENT 'if social media registration then identifier number',
  `social_name` varchar(100) NOT NULL COMMENT 'social media name',
  `email_verify` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'email verification status',
...
--
-- Dumping data for table `lang_expert`
--
...
--
-- Table structure for table `lang_expert_ed`
--

CREATE TABLE `lang_expert_ed` (
  `id` int(11) NOT NULL,
  `exp_id` int(11) NOT NULL,
  `exam_name` varchar(250) NOT NULL COMMENT 'like graduation, post graduation etc',
  `college_name` varchar(200) NOT NULL COMMENT 'college name or university name ',
  `p_year` year(4) NOT NULL COMMENT 'passing year ',
  `marks` varchar(200) NOT NULL COMMENT 'marks and grade',
  `remarks` varchar(250) NOT NULL COMMENT 'add any extra information',
  `status` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='language expert education details';

--
-- Dumping data for table `lang_expert_ed`
--

INSERT INTO `lang_expert_ed` (`id`, `exp_id`, `exam_name`, `college_name`, `p_year`, `marks`, `remarks`, `status`) VALUES
(1, 2, 'Graduation', 'Accnts of Dhaka, Persia', 2012, '80', 'Learnt the spell of reversing the time, but important element is the sands of time', 1),
(2, 4, 'Graduation', 'Accnts of Dhaka, Persia', 2008, '95', 'aer sa g agd asfg asgr asgf wer \r\nadfraf af\r\nafadf afaf af are ', 1);

-- --------------------------------------------------------

--
-- Table structure for table `lang_expert_wh`
--

CREATE TABLE `lang_expert_wh` (
  `id` int(11) NOT NULL,
  `exp_id` int(11) NOT NULL,
  `designation` varchar(150) NOT NULL COMMENT 'position/designation held',
  `company_name` varchar(150) NOT NULL,
  `y_from` date NOT NULL COMMENT 'date started working',
  `y_to` date NOT NULL COMMENT 'last day of work',
  `work_description` mediumtext NOT NULL COMMENT 'work details/ nature of work'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='language expert work history details';

--
-- Dumping data for table `lang_expert_wh`
--

INSERT INTO `lang_expert_wh` (`id`, `exp_id`, `designation`, `company_name`, `y_from`, `y_to`, `work_description`) VALUES
(1, 2, 'Software Engineer', 'Oracle', '2017-02-10', '2017-10-09', 'Checking updated code!! Haha'),
(2, 2, 'Full Stack Developer', 'TCS', '2017-09-21', '2018-04-28', 'removed the gibberish, and writing something ok right now.'),
(3, 10, 'Full Stack Developer', 'Oracle', '2018-04-04', '2018-04-30', 'adfadgfdd jhlos dhvaDFHA D;FHADF;JHADF  loshf sdfh ;sdf'),
(5, 8, 'Full Stack Developer', 'Langecole', '2018-12-31', '2018-12-31', 'sdkhf twt qeroih er  ohf afd alfh a]\r\nadfuuhh af \r\na foiafa\'ithetoiheoti  oeuhw oethwo uw htowht\r\n');

-- --------------------------------------------------------

--
-- Table structure for table `lang_expert_ws`
--

CREATE TABLE `lang_expert_ws` (
  `id` int(11) NOT NULL,
  `exp_id` int(11) NOT NULL COMMENT 'lang_expert_id',
  `sample_name` varchar(250) NOT NULL,
  `description` tinytext NOT NULL COMMENT 'Description of work sample',
...
--
-- Table structure for table `resume_view_history`
--

CREATE TABLE `resume_view_history` (
  `id` int(11) NOT NULL,
  `company_id` int(11) NOT NULL COMMENT 'company id',
  `expert_id` int(11) NOT NULL COMMENT 'expert id',
  `first_view_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'when first time viewed this resume'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='data for resume viewed / downloaded by a company';
...
INSERT INTO `states` (`id`, `name`, `c_id`) VALUES
...
--
-- Indexes for table `lang_company`
--
ALTER TABLE `lang_company`
  ADD PRIMARY KEY (`id`),
  ADD KEY `email_verify` (`email_verify`,`status`);

--
-- Indexes for table `lang_expert`
--
ALTER TABLE `lang_expert`
  ADD PRIMARY KEY (`id`),
  ADD KEY `email_verify` (`email_verify`,`status`);

--
-- Indexes for table `lang_expert_ed`
--
ALTER TABLE `lang_expert_ed`
  ADD PRIMARY KEY (`id`),
  ADD KEY `exp_id` (`exp_id`);

--
-- Indexes for table `lang_expert_wh`
--
ALTER TABLE `lang_expert_wh`
  ADD PRIMARY KEY (`id`),
  ADD KEY `exp_id` (`exp_id`);

--
-- Indexes for table `lang_expert_ws`
--
...
--
-- Indexes for table `resume_view_history`
--
ALTER TABLE `resume_view_history`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `country`
  MODIFY `id` smallint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;
...
--
-- AUTO_INCREMENT for table `lang_company`
--
ALTER TABLE `lang_company`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `lang_expert`
--
ALTER TABLE `lang_expert`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `lang_expert_ed`
--
ALTER TABLE `lang_expert_ed`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `lang_expert_wh`
--
ALTER TABLE `lang_expert_wh`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
